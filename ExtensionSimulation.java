/*
  ...
  Purpose was to simluate agents on a landscape for the extentsion section of my report -- adds new explorer agents.
...
public class ExtensionSimulation {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < numofAgents; i++) {
            ...
            scape.addAgent(new ExplorerAgent(gen.nextDouble() * scape.getWidth(),
                    gen.nextDouble() * scape.getHeight(), radiusSize));
        }
